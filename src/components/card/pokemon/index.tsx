  ...
  return (
    <div className="max-w-fit">
      <Link href={`pokemon/${id}`} className="group relative">
        ...
        <div
          className={`${type.toLowerCase()} relative w-56 h-56 p-4 rounded-lg shadow-md shadow-gray-300 border border-white/25`}
        >
          <div className="absolute h-full w-full top-0 left-0 z-20 ">
            <div className="w-44 h-44 absolute top-[calc(50%-5.5rem)] left-[calc(50%-5.5rem)]">
              {sprite && (
                <Image
